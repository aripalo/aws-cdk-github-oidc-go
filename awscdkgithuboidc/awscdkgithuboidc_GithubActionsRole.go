...
// Experimental.
func GithubActionsRole_FromRoleName(scope constructs.Construct, id *string, roleName *string) awsiam.IRole {
	_init_.Initialize()

	if err := validateGithubActionsRole_FromRoleNameParameters(scope, id, roleName); err != nil {
		panic(err)
	}
	var returns awsiam.IRole
